...
//   try {
//     const info = await sendOtpMail(email, otp); // services/mailer.js 사용
//     setOtp(email, otp); // 5분 TTL 저장
//     console.log(`[OTP 전송 OK] ${email} → OTP: ${otp}, messageId: ${info?.messageId || 'N/A'}`);
//     // ✅ 응답 포맷 그대로 유지
...
//         } else {
//           console.log(`[인증 실패] email: ${email}, 사유: OTP 불일치 또는 만료`);
